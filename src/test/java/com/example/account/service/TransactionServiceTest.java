...
class TransactionServiceTest {
    ...
    void useBalance_UserNotFound() {
        ...
        AccountException exception = assertThrows(AccountException.class,
                () -> transactionService.useBalance(1L, "100000000000",1000L));
    ...
    @Test
    @DisplayName("계좌가 이미 해지된 경우 -  해지 계좌는 사용할 수 없다")
    ...
    void cancelTransaction_AccountNotFound() {
        ...
        // when
        AccountException exception = assertThrows(AccountException.class,
                () -> transactionService.cancelBalance("transactionId", "100000000000",1000L));
